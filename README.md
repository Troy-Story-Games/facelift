...
1. Click "Project > Install Android Build Template..." in the Godot project
1. Attach a headset and run, or run directly on PC and use the simulator controls: WASD, SPACE, SHIFT, Q, E, and R